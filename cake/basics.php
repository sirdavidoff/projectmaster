 ...
 */
	...
	/**
	 * BFS: I am presuming that C put the below in. This needs to be moved out of here as soon as possible;
	 * Updates to the cake libs will break the system until then. I'm putting it back in until I can consult
	 * @todo Move this somewhere else
	 * The above function (__()) cannot be called from inside an array and apparently is
	 * very innefficient because of the debug_backtrace call. This is a better way, defined
	 * here to try to keep the syntax neat
	 */
	function _t($singular, $return = false) {
		return __d('default', $singular, $return);
	}
